...
function filterByWord(originalFlavors){
    if (originalFlavors.include("Chocolate")) {
        return chocFlavors = ["Chocolate", "Chocolate Almond", "Chocolate Chip", "Chocolate Fudge", "Chocolate Mint", "Chocolate Ribbon];
    }
    else{
        return false;
    }
